...
exports.confirmAccount = exports.forgotPassword = exports.register = exports.logout = exports.login = void 0;
...
var register = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fname, lname, email, school, phone, role) {
    var res;
...
var forgotPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset Email sent!');
              window.setTimeout(function () {
  ...
  return function forgotPassword(_x9) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/register/".concat(token),
              data: {
                token: token
              }
            });
          ...
          case 3:
            ...
            // Reassign to account page after 1 second if successful
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account Validated!');
              window.setTimeout(function () {
                location.assign('/account');
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"tabs.js":[function(require,module,exports) {
"use strict";
...
var openTab = function openTab(event) {
  // Declare all variables
  var i, tabcontent, tablinks;
  var tabName = event.target.id; // Get all elements with class="tabcontent" and hide them
  ...
  for (i = 0; i < tablinks.length; i++) {
    tablinks[i].className = tablinks[i].className.replace(' user-page__tabs-links--active', '');
  } // Show the current tab, and add an "active" class to the button that opened the tab


  document.getElementById("".concat(tabName, "-tab")).style.display = 'block';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (type === 'password') {
              ...
              url = "/api/v1/users/resetPassword/".concat(data.resetToken);
            } else {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Information updated successfully!");
              location.assign('/account');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"activeAccount.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.enableAccount = exports.disableAccount = void 0;
...
var disableAccount = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/v1/users/disable/".concat(id);
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Account disabled!");
              location.reload();
            }
  ...
  return function disableAccount(_x) {
    return _ref.apply(this, arguments);
  };
...
var enableAccount = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/api/v1/users/enable/".concat(id);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Account enabled!");
              location.reload();
            }
  ...
  return function enableAccount(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var _activeAccount = require("./activeAccount");
...
var logoutBtn = document.querySelector('.nav-list__link-logout');
var logoutBtnHam = document.querySelector('.navigation-hamburger__link-logout');
var profileTabs = document.getElementsByClassName('user-page__tabs-links');
var userDataForm = document.querySelector('.user-page__settings-data-form');
var setPasswordForm = document.querySelector('.password-form');
var userPasswordForm = document.querySelector('.user-page__settings-pw-form');
var registerForm = document.querySelector('#register-form');
var forgotPwForm = document.querySelector('.forgot-password-form');
var confirmForm = document.querySelector('#confirmAccount');
var resetPwForm = document.querySelector('.reset-password-form');
var disableForm = document.getElementsByClassName('disable-form');
var enableForm = document.getElementsByClassName('enable-form');
var disableId = document.getElementsByClassName('id-input-disable');
var enableId = document.getElementsByClassName('id-input-enable'); // Confirms account using account token when the account confirmation page loads

if (confirmForm) {
  window.onload = function () {
    var confirmToken = document.getElementById('confirm-token').value;
    (0, _login.confirmAccount)(confirmToken);
  };
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // Runs API call to logout user when logout button is clicked

if (logoutBtnHam) logoutBtnHam.addEventListener('click', _login.logout); // Runs API call to register new user when registration form is submitted
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    var school = document.getElementById('school-register').value;
    var phone = document.getElementById('phone-register').value;
    var role = document.getElementById('role-register').value.toLowerCase();
    (0, _login.register)(fname, lname, email, school, phone, role);
  });
...
if (forgotPwForm) {
  forgotPwForm.addEventListener('submit', function (e) {
    ...
    (0, _login.forgotPassword)(resetEmail);
  });
} // Runs API call to set new password when password reset form is submitted


if (resetPwForm) resetPwForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var resetToken, password, passwordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            resetToken = document.getElementById('reset-token').value;
            password = document.getElementById('newPasswordReset').value;
            passwordConfirm = document.getElementById('confirmPasswordReset').value;
            _context.next = 6;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            passwordCurrent = document.getElementById('currPassword').value;
...
if (setPasswordForm) setPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (disableForm) {
  var _loop = function _loop(i) {
    disableForm[i].addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                e.preventDefault();
                id = disableId[i].value;
                _context4.next = 4;
                return (0, _activeAccount.disableAccount)(id);
...
if (enableForm) {
  var _loop2 = function _loop2(_i) {
    enableForm[_i].addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                e.preventDefault();
                id = enableId[_i].value;
                _context5.next = 4;
                return (0, _activeAccount.enableAccount)(id);
  ...
  for (var _i = 0; _i < enableForm.length; _i++) {
    _loop2(_i);
  }
...
if (profileTabs.length > 0) {
  for (var _i2 = 0; _i2 < profileTabs.length; _i2++) {
    profileTabs[_i2].addEventListener('click', _tabs.openTab);
